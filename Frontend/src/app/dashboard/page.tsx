      ...
      <div className="space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8">
          {statCards.map((stat, index) => (
            <div key={index} className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl p-4 border border-white/40 dark:border-gray-700/40 hover:border-white/60 dark:hover:border-gray-600/60 transition-all duration-300 hover:scale-[1.01] overflow-hidden">
              <div className={`absolute inset-0 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-3 transition-opacity duration-300`}></div>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className={`w-2 h-2 bg-gradient-to-r ${stat.color} rounded-full animate-pulse opacity-50`}></div>
                </div>
                ...
                <div className={`mt-3 h-0.5 bg-gradient-to-r ${stat.color} rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}></div>
              </div>
            </div>
          ))}
        </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-300 mb-1">
                    ข้อมูลสำหรับผู้ใช้ (User)
                  </h4>
                  <p className="text-sm text-blue-700 dark:text-blue-400">
                    API Keys จะถูกซ่อนจากผู้ใช้ทั่วไปเพื่อความปลอดภัย เฉพาะผู้ดูแลระบบ (Admin) และผู้จัดการ (Manager) เท่านั้นที่สามารถดูได้
                  </p>
                </div>
              </div>
            </div>
